...
| 层 | 记录（飞书 ID） | 说明 |
|---|---|---|
| A 可黑盒（待扩展） | #3/#4/#5/#6/#7 自定义耗材选择与增删、#14 原模型视图、#20 匹配中（完成态）、#21/#22/#24 映射列表与色差（渲染冒烟）、#25/#26 取消二次确认、#28 无模型提示、#30 多模型、#31-35 物理耗材数量边界（需换 fixture/改耗材列表）、#37/#40/#41 模板与层高、#46/#47 64 色/双拼、#48 持久化（.3mf 重载） | 交互可驱动 + 外部产物可断言 |
| B 弱覆盖/降级 | #2/#8/#9/#23 hover 文案与提示、#38 tooltip、#45 工艺配置默认值、#17/#18/#19 视角盘切换（弹窗内视图区像素 diff）、#39 模板切换确认 | 视觉冒烟或断言弱 |
| C 黑盒不可测 | #11 色域比例/ΔE<1 纯耗材、#13 色域提醒阈值、#22 ΔE 数值分级、#42/43/44 兼容性内部判定、#50 空记录 | 内部数值/矩阵，需白盒兜底或接受风险 |
